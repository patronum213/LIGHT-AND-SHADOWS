...
!player.in_dialogue and !in_dialogue_with_player) {
	...
	if (global.wizard_spoken == true) {
	dialogue = ["As much as I'd like to help you out, I'm afraid I can't right now.", 
	"We're still lacking like. over half of what we wanted in the game so. You'll just have to wait."
	]
	}
	
	
	global.wizard_spoken = true;
