...
function light_delete_all(argument0) {
	/*
	...
	*/
	...
	if (ds_list_size(lights) > 0) {
	for (var i = 1; i < ds_list_size(lights); i++)
	{
	...
	/*if (ds_list_size(casters) > 0) {
	for (var i = 1; i < ds_list_size(casters); i++)
	{
	    if (ds_exists(i, ds_type_list))
	    {
